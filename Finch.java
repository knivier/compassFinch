...
public class Finch extends Robot {
    ...
    {
        return getOrientationBoolean(BEAK_UP);
    }
    
    public boolean isLevel()
    {
        return getOrientationBoolean(LEVEL);
    }
    
    public boolean isUpsideDown()
    {
        return getOrientationBoolean(UPSIDE_DOWN);
    }
    
    public boolean isBeakDown()
    {
        return getOrientationBoolean(BEAK_DOWN);
    }
    
    public boolean isTiltedLeft()
    {
        return getOrientationBoolean(TILT_LEFT);
    }
    
    public boolean isTiltedRight()
    {
        return getOrientationBoolean(TILT_RIGHT);
    }
}
